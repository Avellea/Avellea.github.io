...
window.CONFIG = {
  ...
  bangsList: [
    ...
    },
    {
      trigger: "!apple",
      name: "Apple",
      url: "https://www.apple.com/us/search/{q}",
    },
    {
      trigger: "!ms",
      name: "Microsoft",
      url: "https://www.microsoft.com/en-us/search/result.aspx?q={q}",
    },
    ...
    },
    {
      ...
      url: "https://translate.google.com/?sl=auto&tl=en&text={q}",
    },
    {
      trigger: "!ebay",
      name: "eBay",
    ...
    },
    {
      trigger: "!git",
      name: "Git",
      url: "https://git-scm.com/search/results?search={q}",
    },
    {
      trigger: "!drive",
      name: "Google Drive",
    ...
    },
    {
      trigger: "!docs",
      name: "Google Docs",
      url: "https://docs.google.com/document/u/0/?q={q}",
    },
    {
      trigger: "!mail",
      name: "Gmail",
    ...
    },
    {
      ...
      url: "https://calendar.google.com/calendar/r/search?q={q}",
    },
    {
      trigger: "!medium",
      name: "Medium",
    ...
    },
    {
      trigger: "!figma",
      name: "Figma",
      url: "https://www.figma.com/community/search?resource_type=mixed&sort_by=relevancy&query={q}",
    },
    {
      trigger: "!dribbble",
      name: "Dribbble",
    ...
    },
    {
      trigger: "!behance",
      name: "Behance",
      url: "https://www.behance.net/search?search={q}",
    },
    { trigger: "!vimeo", name: "Vimeo", url: "https://vimeo.com/search?q={q}" },
    {
      trigger: "!twitch",
      name: "Twitch",
      url: "https://www.twitch.org/search?term={q}",
    },
    {
      trigger: "!steam",
      name: "Steam",
    ...
    },
    {
      trigger: "!epic",
      name: "Epic Games",
      url: "https://www.epicgames.com/store/en-US/browse?q={q}",
    },
    {
      trigger: "!claude",
      name: "Claude AI",
    ...
    },
    {
      trigger: "!dis",
      name: "Discord",
      url: "https://discord.com/search?q={q}",
    },
    {
      trigger: "!ytm",
      name: "YouTube Music",
